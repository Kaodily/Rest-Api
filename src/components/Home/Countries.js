  ...
  return (
    <Link to={{ pathname: `/${name.name.common}` }}>
      <div className="flex justify-center mt-9 sm:mr-9 ">
        <div
          className="mb-8 rounded-md h-[300px] w-[200px] bg-white "
          style={mode}>
          ...
          <div className="p-5">
            ...
            <p className="text-[13px] mb-2">
              Population:{" "}
              <span className="text-[hsl(0,0%,52%)]">{name.population}</span>
            </p>
            <p className="text-[13px] mb-2">
              Region:{" "}
              <span className="text-[hsl(0,0%,52%)]">{name.region}</span>
            </p>
            <p className="text-[13px] mb-2">
              Capital:{" "}
              <span className="text-[hsl(0,0%,52%)]">{name.capital}</span>
            </p>
          </div>
        </div>
      </div>
