export const Filtered = ({mode,handleClick}) => {
    return (
        <div className="w-[190px] h-10 mx-5 rounded-sm text-[12px] font-bold px-4 flex items-center " style={mode} onClick={handleClick}>
...
export const Regions = ({mode,modal,handleClick}) => {
    return (
        modal && (
            <div className='w-[190px] top-[215px] mx-5 absolute h-[150px] text-[12px] font-bold' style={mode} >
